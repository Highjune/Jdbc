...
https://youtu.be/4hTkrm64Y9E  Driver Loading하는 방법 4가지. + preparedstatment (32분에 local oracle에서 member테이블 간단하게 만들기. preparedstatement는 loop돌면서 insert할 때 효옹성이 가장 높은데, 그것 실험하기 위해서)
https://youtu.be/0-7-u40qBPk 10분까지
